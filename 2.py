...
Q_e= 2.3263
eplison_c = 2 * 10 ** -6
action_list = np.arange(0,7,1)
n_PD_list = [0,0,1,1,2,2,3,3]
RB_num_list = [1,2,1,2,1,2,1,2]
W_real_list = [4,8,4,8,4,8,4,8]
W_total_list = [4,8,4,8,4,8,4,8]
time_list = [1,1,2,2,3,3,4,4]
TTI_list = [0.0000625,0.0000625,0.0000625,0.0000625,0.0000625,0.0000625,0.0000625,0.0000625]
N_S = 7
N_A = 8
UE_num = 6
MEMORY_SIZE = 3000
...
def work(job_name, task_index, global_ep, lock, r_queue, global_running_r):
    ...
    if job_name == 'ps':
        ...
        if len(reward_ave) > 1:
            ...
            plt.show()
        sio.savemat('C:/Users/ZJX/Desktop/simulation/4_fixedTTI_625_10_1.mat', {'reward_set': re, 'reward_ave': reward_ave, 'W_num': W_num_1, 'TTI_size': TTI_size_1, 'n_PD': n_PD_1, 'eplison': eplison_1,'time': t2,'reward_ave_set':reward_ave,
